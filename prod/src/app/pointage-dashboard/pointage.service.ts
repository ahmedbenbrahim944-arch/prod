...
// ✅ NOUVEAU — statuts manuels justifiés (congé/maladie/mission/etc.)
export interface EnConge {
...
export interface PresenceEmployeeData {
  ...
  totalAbsents: number;
  totalEnConge: number; // ✅ NOUVEAU
  presents: PresenceEmployeeItem[];
  absents: PresenceEmployeeItem[];
  enConge: PresenceEmployeeItem[]; // ✅ NOUVEAU
}
