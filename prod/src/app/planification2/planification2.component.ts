...
@Component({
  selector: 'app-planification2',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './planification2.component.html',
  styleUrls: ['./planification2.component.css']
})
export class Planification2Component implements AfterViewInit, OnInit {
